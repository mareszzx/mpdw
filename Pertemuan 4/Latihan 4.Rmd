...
Hasil analisis menunjukkan adanya ketidaksesuaian antara model ARMA(2,2) yang dibangkitkan dengan perhitungan teoretisnya. Fungsi Autokorelasi Diperluas (EACF) justru menyarankan model yang lebih sederhana, yaitu MA(1). Pola ACF dan PACF data bangkitan yang terpotong setelah lag ke-2 juga mendukung model berorde lebih rendah. Kesimpulannya, meskipun data dibangkitkan dari proses teoretis ARMA(2,2), analisis diagnostik secara konsisten menunjukkan bahwa model MA(1) lebih cocok untuk merepresentasikan data tersebut.
